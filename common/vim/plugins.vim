...
let s:plugin_dir = expand("$MYVIMDIR/plugged")
...
" Your plugins
call s:ensure('editorconfig/editorconfig-vim')
" call s:ensure('akinoyuiko/lightline.vim')
call s:ensure('sainnhe/everforest')
call s:ensure('tpope/vim-sleuth')
...
let g:everforest_floatstyle = "blend"
